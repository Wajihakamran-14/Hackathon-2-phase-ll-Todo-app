...
- Database: Neon Serverless PostgreSQL
- Authentication: Better Auth
- Python 3.13+ + None (using standard library only) (001-console-todo)
- In-memory only (no persistence) (001-console-todo)

## Specialized Agents
- Auth Agent: Handle authentication implementation using Better Auth
- Frontend Agent: Develop frontend using Next.js 16+ (App Router)
- DB Agent: Design and manage Neon Serverless PostgreSQL database with SQLModel
